                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        ...
                        <div class="portfolio-caption">
                            ...
                            <div class="portfolio-caption-subheading text-muted">Room</div>
                            </br>
    ...
    <footer class="footer py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 text-lg-start">Hotel Hebat Website 2022</div>
                ...
                <div class="col-lg-4 text-lg-end">
                    ...
                    <a class="link-dark text-decoration-none" href="#!">Terms of make</a>
                </div>
            </div>
        </div>
    </footer>
